...
public class FastdfsClientTest {
    ...
    //本地文件，要上传的文件
    public String local_filename = "C:\\Users\\ADMIN\\Desktop\\问题.txt";

    static {
        String conf = "fastdfs-client.conf";
        URL url = FastdfsClientTest.class.getClassLoader().getResource(conf);
        conf_filename = url.getFile();
    }
